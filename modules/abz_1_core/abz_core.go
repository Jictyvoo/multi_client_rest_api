...
import (
	...
	"github.com/jictyvoo/multi_client_rest_api/modules/abz_1_core/internal/infra"
...
func NewContactsService(retriever remy.DependencyRetriever) services.ContactsServiceFacade {
	repository := remy.Get[interfaces.ContactsRepository](retriever)
